...
#define CMDLINE_PARSER_PACKAGE "zngconv"
#endif

#ifndef CMDLINE_PARSER_PACKAGE_NAME
/** @brief the complete program name (used for help and version) */
#define CMDLINE_PARSER_PACKAGE_NAME "zngconv"
#endif
...
struct gengetopt_args_info
{
  ...
  char * input_arg;	/**< @brief Input file path.  */
  char * input_orig;	/**< @brief Input file path original value given at command line.  */
  const char *input_help; /**< @brief Input file path help description.  */
  char * output_arg;	/**< @brief Output file path.  */
  char * output_orig;	/**< @brief Output file path original value given at command line.  */
  const char *output_help; /**< @brief Output file path help description.  */
