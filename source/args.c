/*
  ...
  gengetopt --include-getopt -F args 
...
const char *gengetopt_args_info_purpose = "ZNG Converter";

const char *gengetopt_args_info_usage = "Usage: zngconv [OPTION]...";
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_string_field (&(args_info->c1_orig));
  free_string_field (&(args_info->c2_orig));
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 0:	/* Long option with no short option */
          ...
          if (strcmp (long_options[option_index].name, "c1") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->c1_arg), 
                 &(args_info->c1_orig), &(args_info->c1_given),
                &(local_args_info.c1_given), optarg, 0, "12", ARG_INT,
                check_ambiguity, override, 0, 0,
                "c1", '-',
                additional_error))
              goto failure;
          ...
          /* Second pass compression level.  */
          else if (strcmp (long_options[option_index].name, "c2") == 0)
          {
